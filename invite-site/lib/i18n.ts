...
export const translations: Record<string, Record<string, string>> = {
  en: {
    ...
    "hero.stat1": "Days to perfect",
    "hero.stat2": "Revisions",
    ...
    "pricing.essentialTag": "For intimate celebrations",
    "pricing.signatureTag": "Most couples choose this",
  ...
  hi: {
    ...
    "pricing.essentialTag": "छोटे समारोहों के लिए",
    "pricing.signatureTag": "अधिकांश जोड़े यह चुनते हैं",
  ...
  es: {
    ...
    "pricing.essentialTag": "Para celebraciones íntimas",
    "pricing.signatureTag": "La mayoría de parejas eligen esto",
  ...
  fr: {
    ...
    "pricing.signature": "Signature",
    "pricing.essentialTag": "Pour les célébrations intimes",
    "pricing.signatureTag": "La plupart des couples choisissent ceci",
  ...
  de: {
    ...
    "pricing.essential": "Essential",
    "pricing.signature": "Signature",
    "pricing.essentialTag": "Für intime Feiern",
    "pricing.signatureTag": "Die meisten Paare wählen dies",
  ...
  ar: {
    ...
    "pricing.essentialTag": "للاحتفالات الحميمة",
    "pricing.signatureTag": "معظم الأزواج يختارون هذا",
